...
Give every provider API key a short alias (`key1`, `key2`, ...), point your code at the alias instead of the secret, and get rate limits, monthly spend caps, per-key passphrases, alerts, and revoke-without-losing-history.
